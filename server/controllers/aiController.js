...
export const removeImageObject = async (req, res) => {
  try {
    ...
    await sql`INSERT INTO creations (user_id,prompt,content,type,publish) VALUES(${userId},${`Remove ${object} from image`},${imageUrl},'image')`;
...
export const resumeReview = async (req, res) => {
  try {
    ...
    const content = response.choices[0].message.content
    await sql`INSERT INTO creations (user_id,prompt,content,type,publish) VALUES(${userId},"Review the uploaded resume",${content},'image')`;
