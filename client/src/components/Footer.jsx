...
const Footer = () => {
    return (
        ...
        <>
            ...
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm mt-20 text-slate-500 bg-white pt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                      <img src={assets.logo} className='h-9' alt="" />
                        <p className="text-sm/7 mt-6">
                        Exprience the power of AI with QuickAI. <br/> Transform your content creation with our suite of premium AI tools. Write articles, generate images, and enhance your workflow.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-6 max-w-sm">
                            ...
                            <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-indigo-50">
                                ...
                                <button className="bg-primary w-24 h-9 p-2 text-white rounded cursor-pointer">Subscribe</button>
                            </div>
                        </div>
                    </div>
                </div>
