...
const Hero = () => {
    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 relative inline-flex bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen flex-col w-full justify-center'>
